    ...
    <div className="landingPage">
        <div className="landingHero">
          ...
          <div className="landingHero-title">
            <h1 className="banner-h1">DISCOVER THE WORLD WITH SEAMLESS FLIGHT BOOKING!</h1>
            <p className="banner-p">find the best flights in second and enjoy a smooth, hassle-free travel experience.</p>     
          </div>
          ...
          <div className="Flight-search-container input-container mb-4">
                  ...
                  <div className='Flight-search-container-body'>
                    ...
                    ""}
                    <div>
                      <button className="btn btn-success" onClick={fetchFlights}>Search</button>
                    </div>
                    ...
                    <div className="Flights">
                      ...
                      <>
                        ...
                        <div className="Flight" key={Flight._id}>
                            ...
                            <button className="button btn btn-info" onClick={()=>handleTicketBooking(Flight._id, Flight.origin, Flight.destination)}>Book Now</button>
                        </div>
                        )
                      })}
                      </>
